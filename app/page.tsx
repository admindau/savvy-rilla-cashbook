    ...
    <div className="grid md:grid-cols-2 gap-6 items-center">
      <div className="card">
        ...
        <p className="text-white/70 mb-6">
          A simple, powerful cashbook for individuals and teams in South Sudan and beyond.
      ...
      <div className="card">
        <h2 className="text-xl mb-2">What you get</h2>
        <ul className="list-disc ml-6 space-y-2 text-white/80">
          ...
          <li>Monthly budgets & recurring entries</li>
          <li>Charts and clean dark UI</li>
        </ul>
      </div>
    </div>
  );
